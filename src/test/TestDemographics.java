...
public class TestDemographics {
	...
	public Object[][] dataProviderMethod() {
		return new Object[][] { { "1245896325", "First Name must only contain letters" },
				{ "Gilly@", "First Name must only contain letters" }, { "John.Doe", "Last Name is required" },
				{ "JohnDoe25", "First Name must only contain letters" } };
	}
	...
	public void firstNameShouldOnlyHaveLetters(String firstName, String expectedError) throws InterruptedException {
		...
		String validationMsg = signinPage.navigateToIagreePage().clickToAgree().setFName(firstName).nexBtnHasError()
				.getValidationText();
	...
	public void entersValidNameInFirstName(String firstname, String expectedmessage) throws InterruptedException {
		// Arrange
