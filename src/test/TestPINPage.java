...
public class TestPINPage {
	...
	public void entersPINNumber(String Pinnumber, String errorexpected) throws InterruptedException {
		// Arrange

		// Act
		SignInPage getin = new SignInPage(driver);
		String validationMsg = getin.navigatesToPINPage().pinNumber(Pinnumber).continuebtnHasError()
